...
let ingTexto1 = document.getElementById("nombre");
let ingTexto2 = document.getElementById("edad");
let ingTexto3 = document.getElementById("provincia");
let ingTexto4 = document.getElementById("distrito");
let ingTexto5 = document.getElementById("direccion");
let ingTexto6 = document.getElementById("numeroDNI");
let ingTexto7 = document.getElementById("telefono");
let ingTexto8 = document.getElementById("pagar");
